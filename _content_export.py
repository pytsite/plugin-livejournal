...
class _SettingsWidget(_widget.Abstract):
    ...
    def __init__(self, uid: str, **kwargs):
        ...
        _assetman.add('livejournal@js/content-export-settings.js')
    ...
    def get_html_em(self, **kwargs) -> _html.Element:
        ...
        wrapper.add_widget(_widget.input.Text(
            ...
            label=_lang.t('livejournal@username'),
            required=True,
        ...
        wrapper.add_widget(_widget.input.Password(
            ...
            weight=20,
            label=_lang.t('livejournal@password'),
            required=True,
        ...
        wrapper.add_widget(_widget.input.Text(
            ...
            weight=30,
            label=_lang.t('livejournal@lj_like_buttons'),
            help=_lang.t('livejournal@lj_like_buttons_help'),
            value=self._lj_like,
        ))
...
class Driver(_content_export.AbstractDriver):
    ...
    def get_description(self) -> str:
        ...
        """
        return 'livejournal@livejournal'
    ...
    def export(self, entity, exporter):
        ...
        try:
            ...
            msg += '<p>{}: <a href="{}">{}</a></p>'.format(
                _lang.t('livejournal@source', language=entity.language), entity.url, entity.url)
